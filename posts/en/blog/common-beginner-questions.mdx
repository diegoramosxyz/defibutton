...
Decentralized Finance is a concept that refers to a collection of decentralized financial services, also called protocols, that when combined can replace the current centralized financial system. This includes banking, lending, borrowing, trading, exchanging and much more. No one entity determines what forms part of DeFi. The nature of this space allows anyone to create a financial service, and people are free to decide which protocols to use to fulfill their financial needs.

## Why should I care about DeFi?

You should care about decentralized finance (DeFi) because it gives you absolute control over your finances. After the invention of Bitcoin, the first cryptocurrency, DeFi became the next logical step towards a better financial system. One that is open to every internet user in the world, has no "CEO" or "president", has no intermediaries, requires no permission to be used and cannot be censored.
...
DeFi is not a scam, in fact it is much easier to trust than anything we have had in finance before. DeFi is open source code that runs on computers. This means that unlike the centralized financial system, DeFi can be scrutinized by anyone in the world. If you use DeFi protocols that have been audited by security experts, have high volume of transactions and high liquidity, it is unlikely that you will have unexpected outcomes. Computers can't cheat or steal or be negligent. Computers only do what they are programmed to do.
...
[Ethereum](/projects/ethereum) is a decentralized blockchain with smart contract functionality. Smart contracts are **DeFi's foundation**. They allow for the creation automated financial services which remove the need for intermediaries. The [Bitcoin](/projects/bitcoin) blockchain does not support smart contracts, which greatly limits its usefulness when compared to Ethereum.
