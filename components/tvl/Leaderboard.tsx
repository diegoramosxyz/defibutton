...
export default function Leaderboard() {
  ...
  return (
    <section className="table sm:px-3 md:px-0 max-w-sm sm:max-w-screen-xl mx-auto w-full">
      <header className="table-header-group">
        <div className="table-row bg-blue-100 dark:bg-blue-900 font-semibold">
          ...
          <div className="p-2 hidden sm:table-cell text-center md:text-left">24hr %</div>
        </div>
      </header>
      <section className="table-row-group">
        {state.protocols.map(({ name, symbol, chain, tvl, change_1d, category, logo }, idx) => (
          <article
            key={idx}
            className="table-row rounded-md md:rounded-none"
          >
